...
% Syntactic sugar: $\Raise = \ans k \to k$, so that $\den{\Raise} = \lambda k. k$.
% This is useful for recognizing answers of the form $E[\Raise]\ans$ which
% corresponds to raising a data structure corresponding to question formed by
% refocusing the evaluation context $E$.
